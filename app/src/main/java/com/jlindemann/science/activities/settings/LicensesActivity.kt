...
class LicensesActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ConstraintLayout>(R.id.view_lic).systemUiVisibility = View.SYSTEM_UI_FLAG_LAYOUT_STABLE or View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
        ...
        titleBar.setTitle(R.string.license_title)
        titleBar.hideAction()
        ...
        findViewById<ScrollView>(R.id.license_scroll).viewTreeObserver
            .addOnScrollChangedListener(object : android.view.ViewTreeObserver.OnScrollChangedListener {
                ...
                override fun onScrollChanged() {
                    ...
                    val titleDownstateText = findViewById<TextView>(R.id.license_title_downstate)
    ...
    private fun listeners() {
        findViewById<View>(R.id.l_wiki_btn).setOnClickListener {
